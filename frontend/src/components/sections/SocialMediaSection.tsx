    ...
    <section id="midias" className="social-media-section">
      <div className="container social-media-container">
        <div className="social-media-header">
          ...
          <p>
            Fique por dentro de tudo que acontece na Calebe Church. Siga-nos e
            faça parte da nossa comunidade online!
          </p>
        </div>
        <div className="social-media-grid">
          <article className="social-card">
            <div className="social-content">
              ...
              <p>Assista nossos cultos e mensagens.</p>
            </div>
          </article>
          ...
          <article className="social-card">
            <div className="social-content">
              ...
              <p>Siga nossa página e veja as últimas fotos e vídeos.</p>
            </div>
          </article>
        </div>
        ...
        <div className="social-media-footer">
          ...
          <p>Venha nos visitar e fazer parte dessa família ✨</p>
        </div>
      </div>
    </section>
  );
